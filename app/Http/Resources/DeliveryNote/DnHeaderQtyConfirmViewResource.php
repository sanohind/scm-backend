...
class DnHeaderQtyConfirmViewResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            sum(
                function ($detail) {
                    return (new DnDetailQtyConfirmViewResource($detail))->valueForTotalBoxQtyConfirm();
                }
            ),
            'packing_slip' => $this->packing_slip,
            'printed_date' => $this->dn_printed_at,
            'detail' => DnDetailQtyConfirmViewResource::collection($this->whenLoaded('dnDetail')),
        ];
    }
