...
class DN_HeaderQtyOutstandingViewResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            sum(
                function ($detail) {
                    return (new DN_DetailQtyOutstandingViewResource($detail))->valueForTotalBoxOutstanding();
                }
            ),
            'packing_slip' => $this->packing_slip,
            'printed_date' => $this->dn_printed_at,
            'detail' => DN_DetailQtyOutstandingViewResource::collection($this->whenLoaded('dnDetail'))
        ];
    }
