...
class DN_HeaderQtyConfirmViewResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            sum(
                function ($detail) {
                    return (new DN_DetailQtyConfirmViewResource($detail))->valueForTotalBoxQtyConfirm();
                }
            ),
            'packing_slip' => $this->packing_slip,
            'printed_date' => $this->dn_printed_at,
            'detail' => DN_DetailQtyConfirmViewResource::collection($this->whenLoaded('dnDetail'))
        ];
    }
