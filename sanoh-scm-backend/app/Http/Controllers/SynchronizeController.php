...
class SynchronizeController extends Controller
{
    ...
    public function copyPoHeader(){
        // get all data from sql server
        $sqlsrvData = PO_Header_ERP::where('po_period',8)->get();
    ...
    public function copyPoDetail(){
        // get all data from sql server
        $sqlsrvData = PO_Detail_ERP::where('po_period', 8)->get();
    ...
    public function copyDnHeader(){
        // get all data from sql server
        $sqlsrvData = DN_Header_ERP::where('dn_period', 8)->get();
        ...
        foreach ($sqlsrvData as $data) {
            DN_Header::create([
                ...
                'supplier_code' => $data->supplier_code,
                'supplier_name' => $data->supplier_name,
                'dn_created_date' => $data->dn_created_date,
    ...
    public function copyDnDetail(){
        // get all data from sql server
        $sqlsrvData = DN_Detail_ERP::where('dn_period', 8)->get();
